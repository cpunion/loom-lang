...
| `fixtures/lcir-generic-products` | concrete generic records, invariant records, and scalar or managed refined wrappers through projection, contracts, calls, moving-GC roots, debug metadata, real check/build/test/run, host differential execution, and Linux/MSVC object emission |
