...
export function checkReleaseWorkflow({ release, bootstrap, argumentTest }) {
  ...
  for (const expected of [
    ...
    "Reject removed universal runtime ABI exports",
    'node .github/scripts/check-runtime-archive-symbols.mjs "$RUNTIME_ARCHIVE"',
    ...
    "--test builtin_values",
    "--test std_integration",
    "cargo test --locked --release -p loom-runtime-abi --lib",
    "cargo test --locked --release -p loom-runtime --lib",
