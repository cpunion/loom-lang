...
/// Copies the platform entry arguments into an immutable process snapshot.
...
pub unsafe extern "C" fn arguments_initialize_typed_v1(
    ...
    for argument in platform_arguments.iter().skip(1) {
        ...
        // SAFETY: validated non-null above; termination comes from the C entry
        // contract. Lossy conversion gives Loom a valid Unicode Text value.
        arguments.push(
